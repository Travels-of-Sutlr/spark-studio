...
const Spark = (() => {
    ...
    Spark.prototype.unloadCommand = function(cmdName) {
    ...
    Spark.prototype.reloadCommand = function(cmdName) {
    ...
    Spark.prototype.getGuildSettings = async function(id) {
    ...
    Spark.prototype.writeGuildSettings = async function(id, data = {}) {
    ...
    Spark.prototype.permLevel = async function(msg) {
